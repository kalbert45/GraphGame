...
function draw_arrowleft_item(xx, yy, arrow, button, curveStruct, curve_pos, curve_speed, uni_shade, menu_shade, mouse_hover, min_scale, max_scale, scale_spd){
	var txt_scale = 1;
	...
	if (mouse_hover && obj_menu.menu_control) {
		...
		draw_sprite_ext(arrow, 1, xx, yy, txt_scale, txt_scale, 0, c_white, 1);
