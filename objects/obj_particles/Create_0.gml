...
part_type_size(global.starParticle, 0.01, 0.05, 0, 0);
part_type_color3(global.starParticle, $D5F6FF, c_white, $D5F6FF);
part_type_alpha3(global.starParticle, 0.8, 0.5, 0);
...
part_emitter_region(global.P_System, global.Emitter, 0, room_width, 0 , room_height, ps_shape_rectangle, ps_distr_linear);
part_emitter_stream(global.P_System, global.Emitter, global.starParticle, -4);